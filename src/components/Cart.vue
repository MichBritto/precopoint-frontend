        ...
        <div v-if="showCart" class="cart-content" key="cartContent">
          ...
          <div v-else >
            ...
            <button class="cart-summary text-center btn btn-dark btn-sm d-flex align-items-center justify-content-center" @click="abrirFinalizar" style="width: calc(100% - 40px); margin-left: 20px;">
                <i class="fa-solid fa-cart-plus" style="color: white;"></i><span style="margin-left: 5px;" @click="abrirFinalizar">Finalizar</span>
            </button>
        ...
        cartItems: [
            {
                ...
                qtde: 14,
                preco: 2.4,
                imagem: "https://www.minicash.com.br/image/cache/catalog/img/produtos_2021/biscoito-trakinas-chocolate-126gr-600x315w.png",
                descricao: "12unid",
                marcaProduto: "Trakinas",
                categoria: "Mercearia",
            ...
            },
            {
                ...
                qtde: 2,
                preco: 7.0,
                imagem: "https://www.paodeacucar.com/img/uploads/1/980/24738980.png",
                descricao: "2L",
            ...
            },
            {
                ...
                qtde: 3,
                preco: 18.2,
                imagem: "https://boa.vtexassets.com/arquivos/ids/316079/Ovos-branco-grande-Preti-cartela-12-unid.jpg?v=1770376581",
                descricao: "20 unidades",
            ...
            {
                id: 6,
                produto: "Pao de forma",
                qtde: 1,
                preco: 7.0,
                imagem: "https://images-americanas.b2w.io/produtos/01/00/img/1661343/1/1661343140_1GG.jpg",
                descricao: "480g",
                marcaProduto: "Pullman",
                categoria: "Padaria",
                fornecedor: "Carrefour"
            },
            {
                ...
                qtde: 4,
                preco: 9.2,
                imagem: "https://midiasbomdemais.s3.sa-east-1.amazonaws.com/2020/05/P%C3%A3o-de-Forma-Panco-500g-e1590514792861.jpg",
                descricao: "500g",
                marcaProduto: "Panco",
                categoria: "Padaria",
                fornecedor: "Extra"
