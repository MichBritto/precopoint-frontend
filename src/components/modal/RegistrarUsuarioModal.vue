                    ...
                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                        ...
                        <form class="mx-1 mx-md-4" @submit.prevent="criarUsuario">
                            ...
                            <div class="d-flex flex-row align-items-center mb-4 icon-input">
                                ...
                                <div class="form-outline flex-fill mb-0">
                                    <input type="email" id="emailCadastro" class="form-control" v-model="v$.email.$model" :class="{'is-invalid': v$.email.$errors.length}" placeholder="E-mail..."/>
                                    <label v-if="v$.email.$errors.length === 0" class="form-label" for="emailCadastro">E-mail</label>
